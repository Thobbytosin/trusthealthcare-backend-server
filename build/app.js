...
const analytics_route_1 = __importDefault(
  require("./routes/v1/analytics.route")
);
...
exports.app.get("/api/v1/health", (_, res) => {
  ...
  const redisConnected = (0, dbStatus_1.getRedisStatus)();
...
exports.app.use(
  ...
  swagger_ui_express_1.default.setup(swaggerDocument_1.default, {
    swaggerOptions: {
...
exports.app.use(
  "/api/v1/admin",
  user_auth_1.isUserAuthenticated,
  apiKey_auth_1.apiKeyAuth,
