            ...
            parameters: [
                {
                    ...
                    description: "User's cookie consent object (used to determine if request is allowed)",
                },
            ],
            requestBody: {
                required: true,
                        ...
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    ...
                                    message: {
                                        type: "string",
                                        example: "A 6-digit verification code has been sent to your email address",
                                    },
                                },
                            },
                        },
                        ...
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    ...
                                    message: {
                                        type: "string",
                                        example: "Account already exists. Please proceed to sign in to your account",
                                    },
                                },
                            },
                        },
                        ...
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    ...
                                    message: {
                                        type: "string",
                                        example: "A new 6-digit verification code has been re-sent to your email address",
                                    },
                                },
                            },
                        },
