...
exports.isUserAuthenticated = (0, catchAsyncError_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // verify access token
    const decodeAccess = jsonwebtoken_1.default.verify(
      tr_host_x,
...
exports.hasPasswordChangedLast24Hours = (0, catchAsyncError_1.default)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const timeDifference =
        presentDate.getTime() - userLastResetDate.getTime();
